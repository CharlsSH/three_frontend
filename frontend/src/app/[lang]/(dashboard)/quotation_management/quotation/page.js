...
const QuotationAdd = async () => {
  ...
  const data = [
    ...
    },
    {
      ...
      name: "Lexus Car",
      total: 100,
      url: '/images/illustrations/characters/2.png',
    ...
    },
    {
      ...
      name: "Lexus Car",
      total: 100,
      url: '/images/illustrations/characters/4.png',
      invoiceStatus: "Downloaded",
      balance: 0,
      dueDate: `15 ${currentMonth} ${now.getFullYear()}`,
    },
    ...
    },
    {
      ...
      name: "Lexus Car",
      total: 100,
      url: '/images/illustrations/characters/6.png',
      invoiceStatus: "Downloaded",
      balance: 0,
      dueDate: `15 ${currentMonth} ${now.getFullYear()}`,
    },
    ...
    },
    {
      ...
      name: "Lexus Car",
      total: 100,
      url: '/images/illustrations/characters/8.png',
      invoiceStatus: "Downloaded",
      balance: 0,
      dueDate: `15 ${currentMonth} ${now.getFullYear()}`,
    },
